// Variables Generales
localStorage.clear()
const listaA = {'general': 'Juan Perez', 'endodoncia': 'Agustina Morón', 'ortodoncia': 'Lucía Ferrera', 'radiografias': 'Lucas Vinicius'};
const listaB = {'general': 'Facundo García', 'endodoncia': 'Soledad Rodriguez', 'ortodoncia': 'Maria Valtazar', 'radiografias': 'Carlos Pereyra'};
...
// "main" se encarga de construir la línea del programa.
    ...
    fetch('registros.json', {
        ...
        // archivo .json.
        method: 'POST',
        body: localStorage.getItem('cliente'),
    headers: {
